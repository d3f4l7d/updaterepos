...
rm -rf ~/.config/d3f4l7d/airarch
rm -rf ~/.config/d3f4l7d/werewolf
rm -rf ~/.config/d3f4l7d/safearch
rm -rf ~/.config/d3f4l7d/archjekyll
...
git clone https://github.com/d3f4l7d/airarch.git ~/.config/d3f4l7d/airarch
...
git clone https://github.com/d3f4l7d/archjekyll.git ~/.config/d3f4l7d/archjekyll
...
git clone https://github.com/d3f4l7d/archlightningpose3d.git ~/.config/d3f4l7d/archlightningpose3d
